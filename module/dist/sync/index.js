 ...
 */
function withinViewport(elem, userOptions) {
    let containerBoundingRect;
    let containerScrollTop = 0;
    let containerScrollLeft = 0;
    const scrollBarWidths = [0, 0];
    const config = (0, options_js_1.getConfig)('sync', elem, userOptions);
    ...
    return sides_js_1.sides.every((side) => isWithin[side]());
}
